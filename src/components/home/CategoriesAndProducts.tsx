                    ...
                    return(
                        <div className="col-span-1 flex flex-col items-center h-[500px] group" key={number}>
                            <div className="w-full h-[400px] bg-[#F3F3F3] border border-[#E6E6E6] flex items-center justify-center relative">
                                ...
                                {!location.pathname.includes('wishlist') && <img src="/images/heart.svg" className="cursor-pointer absolute top-[20px] right-[10px] transition-transform duration-200 hover:scale-[0.9]" />}
                                {location.pathname.includes('wishlist') && <img src="/images/heartfilled.svg" className="cursor-pointer absolute top-[20px] right-[10px] transition-transform duration-200 hover:scale-[0.9]" />}
