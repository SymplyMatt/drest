...
const Auth = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 50 }} transition={{ duration: 0.4, ease: "easeOut" }} className="min-w-[100%] w-[100vw] min-h-[100%] h-[100vh] fixed top-0 right-0 bg-[#1415114D] z-10 flex justify-center tmd:pt-[46px] pb-[80px]">
