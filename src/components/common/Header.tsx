...
const Header = () => {
    return (
        <div className="w-full flex flex-col">
            <div className="w-full flex h-[42px] bg-headerBlack items-center justify-between text-textWhite px-[30px]">
            ...
            <div className="w-full h-[92px] flex border-b border-[#E6E6E6] px-[30px] justify-between items-center">
            ...
            <div className="border-b border-[#E6E6E6] h-[48px] w-full px-[30px] flex items-center justify-between">
